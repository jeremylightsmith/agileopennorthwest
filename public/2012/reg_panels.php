...
<?php } elseif ( $event_status == 'past' ) { ?>
  ...
  <p>Agile Open Northwest <?php echo $event_year; ?> was a success. You can read session notes <a href="../wiki/index.php?title=<?php echo $session_notes; ?>">here</a>. We hope to see you at
   the next Agile Open Northwest event.</p>

...
?>
        ...
        <p class="subtitle">What topics are suitable for an Open Space session?</p>
        ...
        <p class="subtitle">Do I have to be an expert in the topic to host a session?</p>
        ...
        <p class="subtitle">Can I add a session after the Opening?</p>
        ...
        <p class="subtitle">Will there be a record of sessions?</p>
        ...
        <p class="subtitle">Are accomodations available?</p>
         <p> There are a number of hotels, in all price ranges nearby. At the time of this writing, we are working on a discount at a nearby hotel. Please see <a href="location.php">the location page</a> and follow <a href="http://twitter.com/aonw">announcements on Twitter</a>. </p>

...
<body>
<div id="page">
<div id="logo"><a href="index.php"><img src="images/agilenwlogo_2009.png" name="stdimage" id="stdimage" /></a>
  <div id="nav">
    <ul>
	  ...
	  <li><a href="../wiki/index.php?title=Agile_Open_Northwest_2009_Session_Notes">Session Notes</a>

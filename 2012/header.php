...
<body>
<div id="page">
<div id="logo"><a href="index.php"><img src="images/agilenwlogo_2012.png" name="stdimage" id="stdimage" /></a>
  <div id="nav">
    <ul>
<?php
      ...
      menu_item("Session&nbsp;Notes", "../wiki/index.php?title=$session_notes", $wiki_status == 'online');

...
<p>Space is limited to <strong><?php echo $event_limit; ?> participants</strong>, so <strong>register early!</strong></p>

<p>Registration cost is $150 for the two days, including a light breakfast and box lunch on both days.</p>
...
after January 24, 2012. Another option if you are unable to attend is to substitute 
someone else in your place.</p>

<p>The <strong>Register Now!</strong> button takes you to our registration service.</p>

<p>If you have used the Regonline system to register for Agile Open Northwest before
(or for other events) the system remembers your email and password and 

...
<body>
<div id="page">
<div id="logo"><a href="index.php"><img src="images/agilenwlogo_2011.png" name="stdimage" id="stdimage" /></a>
  <div id="nav">
    <ul>
<?php
      ...
      menu_item("Session&nbsp;Notes", "../wiki/index.php?title=Agile_Open_Northwest_2011_Session_Notes", $wiki_status != 'offline');
